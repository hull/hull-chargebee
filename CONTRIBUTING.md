...
You can [open a ticket](https://github.com/hull/hull-chargebee/issues/new) with your questions or issues any time. Feature requests are also welcome, please describe the feature, why you need it, and how it should work.
...
- You are using the [latest version](https://github.com/hull/hull-chargebee/releases).
- You have read the [technical documentation](https://github.com/hull/hull-chargebee/blob/master/README.md) and the [user documentation](https://github.com/hull/hull-chargebee/blob/master/assets/readme.md) first, and
